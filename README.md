...
Our assessment method has the following advantages:

1) High intelligibility: This method ensures that the evaluation algorithm finds truly the redundant structures that have a relatively minor impact on the network in an understandable manner.
